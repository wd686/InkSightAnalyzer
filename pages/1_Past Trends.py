...
startPeriod_str = startEndPeriods_df['Month of Response Date'].head(1).reset_index()['Month of Response Date'][0]
endPeriod_str = startEndPeriods_df['Month of Response Date'].tail(1).reset_index()['Month of Response Date'][0]
